...
setwd('/Users/nanditareddy/Desktop/R BOOTCAMP/A1b')

install.packages("fitdistrplus")
# Load datasets
ipl_bbb <- read_csv('/Users/nanditareddy/Desktop/R BOOTCAMP/A1b/IPL_ball_by_ball_updated till 2024.csv')
ipl_salary <- read_excel('/Users/nanditareddy/Desktop/R BOOTCAMP/A1b/IPL SALARIES 2024.xlsx')
...
# Filter the runs scored by Shubman Gill
Shubman_Gill_runs <- runs %>% filter(Striker == "Shubman Gill") %>% pull(runs_scored)
...
# Fit the distribution to Shubman Gill's runs scored and get the best distribution
best_distribution <- get_best_distribution(Shubman_Gill_runs)
